 ...
 */
export type PackListingAdditionalInformation = {
  /**
   * URL or reference to video walkthrough for agent verification.
   */
  videoWalkthrough?: string | null;
